...
- Configured removable-media execution control, AutoRun/AutoPlay protection, Microsoft Defender hardening, UAC secure desktop, and Advanced Audit Policy.
...
The current GPO stage reduces malware execution from removable storage, disables automatic content execution, strengthens Defender and UAC behavior, and records logon, account-management, process-creation, command-line, and removable-storage activity.
...
- [x] Configure endpoint auditing and removable-media protection.
